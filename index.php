...
<body>
    <div class="ui inverted huge borderless fixed fluid menu">
      <a class="header item" >RECEIPT MANAGER</a>
    </div><br>
<div class="ui text container" style="margin-top:90px">
<div id="err001" class="ui icon small attached message">
<i class="notched circle loading icon"></i> 
<div class="content">
<div class="header">User Panels....</div>
<p>Please select the appropriate user to Log In </p>
<div id="proceed"></div>
</div>
</div>
<div class="ui attached bottom message">
<div class="ui horizontal divider">Check your Receipt?</div>
<form onsubmit="return ordval(this)">
<div id="refbox" class="ui icon input small">
<input placeholder="Enter Serial No." id="refinput" required>
 <i class="search icon"></i>
</div>
<button id="printbtn" class="ui button small blue">Check</button>
</form>
...
<script>
setTimeout(function(){document.getElementById("proceed").innerHTML="<a href='user/login.php' class='ui button small green'>User Login</a> <a href='admin/login.php' class='ui button small orange'>Admin Login</a> "},2000);
</script>
</body>
</html>